...
public class Room4SDSPickup : MonoBehaviour
{
    ...
    public static GameObject containerBox2;
	...
	public void GetButtons()
    {
        ...
        containerBox2 = GameObject.Find("Cube4");
	}
	...
	void OnTriggerStay(Collider other)
    {
        ...
        if (other.gameObject.transform.name == "Player" && gameObject.transform.name == "AtStorageTrigger4" && PickupObject.carriedObject.transform.name == "container1")
        {
            DialogueManager.Instance.SendMessage("OnSequencerMessage", "Storage1");
        }

			if(PickupObject.carriedObject == null && readyToStore && other.gameObject.transform.name == "container1")
            {
