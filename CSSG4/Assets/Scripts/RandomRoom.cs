...
public class RandomRoom : MonoBehaviour
{
    ...
    public void Generate()
    {
        ...
        if (GameObject.Find("SequenceCamera") != null)
        {
            // move sequence camera to new room
            GameObject.Find("SequenceCamera").transform.position = newRoom.transform.position + new Vector3(0, 1, 0);
        }
        ...
        {
            DoorAnimation doorAnimation = (DoorAnimation)door.GetComponent(typeof(DoorAnimation));
    ...
    {
        float distanceToA = Vector3.Distance((newHall.transform.position + newRoom.transform.position) / 2, a.transform.position);
        float distanceToB = Vector3.Distance((newHall.transform.position + newRoom.transform.position) / 2, b.transform.position);
    ...
    void NextRoom()
    {
        ...
        ((SQL)GameObject.Find("GameFunctions").GetComponent("SQL")).RefreshSettings();
    }
