...
public class PickupObject : MonoBehaviour
{
                ...
                else
                {
                    ...
                    if (p.gameObject.transform.name == "Tablet" || p.gameObject.CompareTag("SDSTablet"))
                    {
                        if (Camera.main.GetComponent<MouseLook>().enabled)
                        {
                            ...
                            carriedObject.transform.position = Camera.main.transform.position + Camera.main.transform.forward * .45f;
                    ...
                    else if (p != null && Vector3.Distance(Camera.main.transform.position, p.transform.position) < 3.0f)
                    {
                        if (p.Check != true)
                        {
                            ...
                            if (carriedObject.CompareTag("SDSContainer") == false)
                            {
    ...
    {
        float distanceToA = Vector3.Distance(Camera.main.transform.position, a.transform.position);
        float distanceToB = Vector3.Distance(Camera.main.transform.position, b.transform.position);
