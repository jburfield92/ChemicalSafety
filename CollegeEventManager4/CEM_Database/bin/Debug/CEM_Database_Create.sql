/*
Deployment script for CEM_Database
...
GO
:setvar DatabaseName "CEM_Database"
:setvar DefaultFilePrefix "CEM_Database"
...
CREATE TABLE [dbo].[EventRating] (
    ...
    [Rating]        INT              NOT NULL,
    PRIMARY KEY CLUSTERED ([EventRatingID] ASC)
);
...
CREATE TABLE [dbo].[Member] (
    ...
    PRIMARY KEY CLUSTERED ([RSOMemberID] ASC)
);
...
GO
PRINT N'Creating [dbo].[EventCategory]...';
...
GO
PRINT N'Creating [dbo].[FK_EventRating_User]...';


GO
ALTER TABLE [dbo].[EventRating]
    ADD CONSTRAINT [FK_EventRating_User] FOREIGN KEY ([UserID]) REFERENCES [dbo].[User] ([UserID]);


GO
PRINT N'Creating [dbo].[FK_EventRating_Event]...';


GO
ALTER TABLE [dbo].[EventRating]
    ADD CONSTRAINT [FK_EventRating_Event] FOREIGN KEY ([EventID]) REFERENCES [dbo].[Event] ([EventID]);
...
GO
ALTER TABLE [dbo].[Event]
    ADD CONSTRAINT [FK_Event_Location] FOREIGN KEY ([LocationID]) REFERENCES [dbo].[Location] ([LocationID]);


GO
PRINT N'Creating [dbo].[FK_Event_EventType]...';


GO
ALTER TABLE [dbo].[Event]
    ADD CONSTRAINT [FK_Event_EventType] FOREIGN KEY ([EventTypeID]) REFERENCES [dbo].[EventType] ([EventTypeID]);


GO
PRINT N'Creating [dbo].[FK_Event_EventCategory]...';


GO
ALTER TABLE [dbo].[Event]
    ADD CONSTRAINT [FK_Event_EventCategory] FOREIGN KEY ([EventCategoryID]) REFERENCES [dbo].[EventCategory] ([EventCategoryID]);
...
GO
ALTER TABLE [dbo].[Event]
    ADD CONSTRAINT [FK_Event_User] FOREIGN KEY ([AdminID]) REFERENCES [dbo].[User] ([UserID]);


GO
PRINT N'Creating [dbo].[FK_Event_University]...';


GO
ALTER TABLE [dbo].[Event]
    ADD CONSTRAINT [FK_Event_University] FOREIGN KEY ([UniversityID]) REFERENCES [dbo].[University] ([UniversityID]);


GO
PRINT N'Creating [dbo].[FK_Event_RSO]...';


GO
ALTER TABLE [dbo].[Event]
    ADD CONSTRAINT [FK_Event_RSO] FOREIGN KEY ([RSOID]) REFERENCES [dbo].[RSO] ([RSOID]);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b539adeb-f122-425b-b3ab-66581ccff4c4')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b539adeb-f122-425b-b3ab-66581ccff4c4')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '2268803e-8818-479b-b481-60e83588c6e8')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('2268803e-8818-479b-b481-60e83588c6e8')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'abac7d7e-e33e-46e1-9a39-a78ef90035a5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('abac7d7e-e33e-46e1-9a39-a78ef90035a5')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '66084a87-f56b-4dc0-8109-992997549a34')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('66084a87-f56b-4dc0-8109-992997549a34')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '755804f7-20a9-44a5-a8b9-1902e8f3ddf7')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('755804f7-20a9-44a5-a8b9-1902e8f3ddf7')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '8501beb9-e65d-4a40-9a8b-cfdb5b8d25a3')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('8501beb9-e65d-4a40-9a8b-cfdb5b8d25a3')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '5160ffdc-b9f9-4c1b-9535-13af0f7a2508')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('5160ffdc-b9f9-4c1b-9535-13af0f7a2508')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '207f2a3b-73d8-4575-85d3-b06511c8f269')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('207f2a3b-73d8-4575-85d3-b06511c8f269')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'ebea00e4-0979-4f1e-af2c-d7a70ff31268')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('ebea00e4-0979-4f1e-af2c-d7a70ff31268')
